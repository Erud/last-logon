...
Dim strBase, strFilter, strAttributes, lngHigh, lngLow , bitSW , strLLDate , strCrDate
...
arrstrDCs(0) = "rlicdc1.reshealthcare.org"
...
For k = 0 To 0
  ...
  Else
    On Error GoTo 0
      ...
      End if
      'If Not objListD.Exists(strDN) Then objListD.Add strDN, DateDiff("d", dtmDate, Now)
      objRecordSet.MoveNext
    Loop
  End If
Next
...
Wscript.Echo "Last Logon;Creation Date;User Name;Display Name;Name;Description;Days Inactive;Distinguished Name"
For Each strUser In objList
  If (DateDiff("d", objList(strUser), Now) > 135) and (DateDiff("d", objListCr(strUser), Now) > 135) then
     ...
     & ";" & objUser.sAMAccountName & ";" & Replace(objUser.displayName ,";",",",1,-1,1) & ";" & objUser.cn & ";" _
     & Replace(objUser.description ,";",",",1,-1,1) _
